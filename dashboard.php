...
<body>
    ...
    <main class="wrapper">
        ...
        <div class="contenido">
            <h1 class="titulo">SUMMARY OF YOUR VIRTUAL STORE</h1>
            ...
            <div class="contenedor_resumen">
                <div class="contenedor_progress_bar">
                    ...
                    <div class="contenedor_grid">
                        <div class="grid_item">
                            <span class="item_titulo">Details</span>
                            ...
                            if (
                                ...
                                echo '
                                        <span class="item_status">Completed</span>
                                    ';
                            } else {
                                echo '
                                        <span class="item_status-gray">Pending</span>
                                    ';
                            }
                            ?>
                        </div>
                ...
                <div class="contenedor_items_resumen">
                    <div class="resumen_item_grande">
                        ...
                        <div class="contenedor_tooltip">
                            <div class="tooltip">
                                <p>
                                    Here you can see the content of the 'Store Details' section.
                                </p>
                            </div>
                        </div>

                        <a href="assets/vistas/datosTienda.php">
                            <h2 class="resumen_titulo">Store Details</h2>
                        </a>
                    ...
                    <div class="resumen_item">
                        ...
                        <div class="contenedor_tooltip">
                            <div class="tooltip">
                                <p>
                                    Here you can see the content of the 'Styles' section.
                                </p>
                            </div>
                        </div>
