...
<head>
    ...
    <link rel="stylesheet" href="https://www.platform.kalstein.net/template-editor/assets/css/plantilla/estilos.css">
    <link rel="stylesheet" href="https://www.platform.kalstein.net/template-editor/assets/css/plantilla/productos.css">
    <link rel="stylesheet" href="https://www.platform.kalstein.net/template-editor/assets/css/plantilla/nosotros.css">

    <!-- Icono del sitio (favicon) -->
    <link rel="icon" href="https://www.platform.kalstein.net/template-editor/assets/img/favicon/favicon.ico"
        type="image/x-icon">
...
<body>
    ...
    <div id="seccion_inicial">
            ...
            <div class="contenedor_form_buscador">
                <form action="" method="GET" class="form_buscador formulario_ajax">
                    <input type="search" name="buscador"
                        placeholder="Search by reference, catalog, product, keyword or brand..." class="buscador_input"
                        required>
                ...
                <figure class="banner_img">
                    ...
                    if (!empty($datos_plantilla['banner_t'])) {
                        ...
                        echo '
                                ...
                                <img src="https://platform.kalstein.net/template-editor/assets/img/banner-2.png" alt="Banner">
                                <div class="contenedor_btn_welcome">
                                    <a href="#marcador_productos" class="btn_welcome">
                                        <span>See products</span>
                                    </a>
        ...
        <main class="contenedor_principal">
                    ...
                    if (mysqli_num_rows($consulta_productos_limit) > 0) {
                        ...
                        echo '
                                <div class="item_doble elementoScroll">
                                    <a href="#" class="item_doble_enlace btn_productos">
                                        <figure class="item_doble_img">
                                            <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="item">
                                        </figure>
                                    </a>
            ...
            <h2 class="titulo_secundario">
                See our <strong style="color: <?php if (isset($color_p)) {
                    echo $color_p;
                } else {
                    echo 'var(--color-primario)';
                } ?>;">Products</strong>
                ...
                <div class="carousel_wrapper">
                    ...
                    if (mysqli_num_rows($consulta_productos_img) > 0) {
                        ...
                        echo '
                                <a href="#" class="carousel_contenedor_imagen btn_productos">
                                    <figure>
                                        <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="Producto 1">
                                    </figure>
                                </a>
            
                                <a href="#" class="carousel_contenedor_imagen btn_productos">
                                    <figure>
                                        <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="Producto 2">
                                    </figure>
                                </a>
            
                                <a href="#" class="carousel_contenedor_imagen btn_productos">
                                    <figure>
                                        <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="Producto 3">
                                    </figure>
                                </a>
            
                                <a href="#" class="carousel_contenedor_imagen btn_productos">
                                    <figure>
                                        <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="Producto 4">
                                    </figure>
                                </a>
            
                                <a href="#" class="carousel_contenedor_imagen btn_productos">
                                    <figure>
                                        <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="Producto 5">
                                    </figure>
                                </a>
            
                                <a href="#" class="carousel_contenedor_imagen btn_productos">
                                    <figure>
                                        <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="Producto 6">
                                    </figure>
                                </a>
            
                                <a href="#" class="carousel_contenedor_imagen btn_productos">
                                    <figure>
                                        <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="Producto 7">
                                    </figure>
                                </a>
                            ';
                    } else {
            ...
            <h2 class="titulo_secundario fondo_titulo">
                ...
                if (isset($datos_plantilla['subtitulo_t']) && !empty($datos_plantilla['subtitulo_t'])) {
                    ...
                    echo 'Secondary title of the store!';
                } else {
                    echo 'Secondary title of the store!';
                }
                ?>
            ...
            <div class="contenedor_img_individuales elementoScrollDos">
                ...
                if (mysqli_num_rows($consulta_productos_img_dos) > 0) {
                    ...
                    echo '
                            ...
                            <div class="contenedor_img_individual">
                                <figure class="img_individual">
                                    <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="banner two">
                                </figure>
                                <a href="#" class="img_individual_enlace btn_productos">
                                    See more
                                    <svg class="icono_ver_mas-white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                            ...
                            <div class="contenedor_img_individual">
                                <figure class="img_individual">
                                    <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="banner three">
                                </figure>
                                <a href="#" class="img_individual_enlace btn_productos">
                                    See more
                                    <svg class="icono_ver_mas-white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                ...
                <div class="historia elementoScroll">
                    ...
                    <figure class="historia_img">
                        ...
                        if (!empty($datos_plantilla['img_quienes_s'])) {
                            ...
                            echo '
                                    <img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="imagen_empresa">
                                    
                                ';
                        } else {
                            echo '<img src="https://platform.kalstein.net/template-editor/assets/img/banner-default.png" alt="imagen_empresa">';
                        }
                        ?>
                    </figure>
                </div>
    ...
    <?php
    include ("/home/he270716/public_html/platform.kalstein.net/template-editor/assets/includes/footer_plantilla.php");
    ?>

    <!-- Scripts -->
    <script src="https://platform.kalstein.net/template-editor/assets/js/jquery-3.6.0.min.js"></script>
    <script src="https://platform.kalstein.net/template-editor/assets/js/plantilla/main.js"></script>
    <script src="https://platform.kalstein.net/template-editor/assets/js/plantilla/productos.js"></script>
    <script src="https://platform.kalstein.net/template-editor/assets/js/plantilla/footer_plantilla.js"></script>
</body>
