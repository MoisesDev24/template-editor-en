...
<body>
    ...
    <main class="wrapper">
        ...
        <div class="contenido">
            ...
            <h1 class="titulo_secundario">RENDER YOUR PRODUCTS IN 3D</h1>

            <div class="contenedor_datos">
                <div class="contenedor_products3d">
                    <div class="contenedor_parrafo">
                        <p>
                            Next, you must choose which of your Products you want to render to obtain a 3D model of
                            them, and thus be able to visualize them in your Store.:
                        </p>
                    </div>
                    ...
                    <form action="../app/controllers/products3d_controller.php" data-tipo="formulario4" method="POST"
                        ...
                        <div class="form_header_container">
                            <h2 class="titulo_products3d">Select the Product you want to Render.</h2>
                            <span class="max_ten_products">Max. 5 Products</span>
                        ...
                        <div class="contenedor_datos_botones">
                            <button type="reset" class="btn_limpiar" id="btn_limpiar">Clear</button>
                ...
                <div class="sombra mt-2">
                    <div class="table100">
                        <h3 class="titulo-table">Products pending for rendering.</h3>
                        <table>
                            <thead>
                                <tr class="table100-head">
                                    <th class="column1">Image</th>
                                    <th class="column2">Request Date</th>
