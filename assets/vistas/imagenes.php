...
<body>
    ...
    <main class="wrapper">
        ...
        <div class="contenido">
            ...
            <h1 class="titulo_secundario">ADD IMAGES TO YOUR STORE</h1>

            <div class="contenedor_datos">
                <div class="contenedor_imagenes">
                    <div class="menu_opciones">
                        <ul class="lista_opciones">
                            <li class="opciones_item"><span>Main Banner</span></li>
                            <li class="opciones_item"><span>Who are we?</span></li>
                    ...
                    <form action="../app/controllers/imagenesTienda_controller.php" data-tipo="formulario3"
                        ...
                        <div class="contenedor_imagen" id="banner_principal">
                            ...
                            <div class="contenedor_tooltip" style="right: 40px;">
                                <div class="tooltip">
                                    <p>
                                        Add a banner for your Virtual Store. It should measure between 1900x1000px wide,
                                        and 600x350px tall.
                                    </p>
                                </div>
                            </div>

                            <h2 class="titulo_imagenes">Main Banner</h2>

                            <div class="contenedor_subir_imagen">
                                <label for="banner_p">Upload main banner image</label>
                            ...
                            <div class="vista_previa_img">
                                <h3 class="titulo_vista_p">Image preview</h3>
                        ...
                        <div class="contenedor_imagen" id="quienes_somos">
                            ...
                            <div class="contenedor_tooltip" style="right: 40px;">
                                <div class="tooltip">
                                    <p>
                                        Add an image for your Company's identity. It should measure between 900x380px
                                        wide and 600x100px tall.
                                    </p>
                                </div>
                            </div>

                            <h2 class="titulo_imagenes">Who are we?</h2>

                            <div class="contenedor_subir_imagen">
                                <label for="quienes_somos_t">Upload image for the 'Who We Are?' section."</label>
                                <div class="input-container">
                                    <?php
                        ...
                        <div class="contenedor_imagen" id="mision">
                            ...
                            <div class="contenedor_tooltip" style="right: 40px;">
                                <div class="tooltip">
                                    <p>
                                        Add an image for your Company's mission. It should measure between 900x380px
                                        wide and 600x100px tall.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="contenedor_subir_imagen">
                                <label for="mision_img">Upload image for the 'Mission' section.</label>
                                <div class="input-container">
                                    <?php
                        ...
                        <div class="contenedor_imagen" id="vision">
                            ...
                            <div class="contenedor_tooltip" style="right: 40px;">
                                <div class="tooltip">
                                    <p>
                                        Add an image for your Company's vision. It should measure between 900x380px wide
                                        and 600x100px tall.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="contenedor_subir_imagen">
                                <label for="imagen_vision">"Upload image for the 'Vision' section."</label>
                                <div class="input-container">
                                    <?php
