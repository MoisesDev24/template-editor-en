<?php
    ...
    if (isset($_SESSION["emailAccount"])) {
        ...
        echo "<script>
            ...
            window.location.replace('https://platform.kalstein.net/acceder/'); 
            </script>";
    }
?>
...
<?php
    ...
    include ("../app/sql/sql_datosPlantilla.php");
?>
...
<head>
    ...
    <link rel="stylesheet" href="../css/plantilla/productos.css">
    <link rel="stylesheet" href="../css/plantilla/nosotros.css">
...
<body>
        ...
        <header class="cabecera">
            <nav class="navbar" id="navbar">
                <div class="navbar_contenedor_uno">
                    ...
                    if (!empty($datos_plantilla['logo_t'])) {
                        ...
                        echo '
                                <a href="https://platform.kalstein.net/template-editor/assets/vistas/datosTienda.php" class="btn_inicio_2 efecto_edit" title="Add your logo here">
                                    <figure class="navbar_img">
                                        <img src="../img/logo-default-2.png" alt="logo_empresa">
                                    </figure>
                                </a>
                            ';
                    }
                ...
                <div class="navbar_contenedor_dos">
                    <ul class="navbar_lista">
                        <li class="navbar_item"><a href="#" class="btn_inicio"><span>Store</span></a></li>
                        <li class="navbar_item"><a href="#" class="btn_productos"><span>Products</span></a></li>
                    </ul>
                </div>
                ...
                <div class="modal_dropdown">
                    <div class="dropdown">
                        <ul class="dropdown_lista">
                            <li class="navbar_item_drop"><a href="#" class="btn_inicio"><span>Store</span></a></li>
                            <li class="navbar_item_drop"><a href="#" class="btn_productos"><span>Products</span></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="contenedor_form_buscador">
                <form action="" method="GET" class="form_buscador formulario_ajax">
                    <input type="search" name="buscador"
                        placeholder="Search by reference, catalog, product, keyword, or brand..."
            ...
            <div class="banner">
                <figure class="banner_img">
                    <?php
                    if (!empty($datos_plantilla['titulo_t']) && empty($datos_plantilla['banner_t'])) {
                        echo '
                            ...
                            ';
                    } elseif (empty($datos_plantilla['titulo_t']) && !empty($datos_plantilla['banner_t'])) {
                        echo '
                                <h1 class="titulo_principal" style="color: ' . (isset($color_p) ? $color_p : 'var(--color-primario)') . ';">
                                    Virtual Store Title
                                </h1>
                        ...
                        echo '
                                <a href="https://platform.kalstein.net/template-editor/assets/vistas/imagenes.php#banner_p" class="efecto_edit" title="Agrega un Banner aquí">
                                    <h1 class="titulo_principal" style="color: ' . (isset($color_p) ? $color_p : 'var(--color-primario)') . ';">
                                    Virtual Store Title
                                    </h1>
                                    <img src="../img/banner-2.png" alt="Banner">
        ...
        <main class="contenedor_principal">
            ...
            <?php
                if (isset($datos_plantilla['titulo_t']) && !empty($datos_plantilla['titulo_t'])) {
                    ...
                    echo '
                            <a href="https://platform.kalstein.net/template-editor/assets/vistas/datosTienda.php#descripcion_tienda" class="btn_contenedor_tienda" title="Add a Title and Description here.">
            ...
            <h2 class="titulo_secundario" id="marcador_productos">
                Discover our <strong style="color: <?php if (isset($color_p)) {
                    echo $color_p;
                } else {
                ...
                <?php
                    if (mysqli_num_rows($consulta_productos_limit) > 0) {
                        while ($datos_producto_limit = mysqli_fetch_array($consulta_productos_limit)) {
                                    ...
                                    <div class="item_doble elementoScroll">
                                        <a href="#" class="item_doble_enlace btn_productos">
                                            <figure class="item_doble_img">
                                                <img src="' . $datos_producto_limit["product_image"] . '" alt="' . $datos_producto_limit["product_name_en"] . '">
                                            </figure>
                                        </a>
                            ...
                            // Escapamos los apóstrofes en el nombre del producto
                        ...
                        echo '
                                <div class="item_doble elementoScroll">
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="item_doble_enlace efecto_edit" title="Add a product here">
                                        <figure class="item_doble_img">
                                            <img src="../img/banner-default.png" alt="item">
                                        </figure>
                                    </a>
                
                                    <div class="item_informacion">
                                        <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="efecto_edit" title="Add a product here">
                                            <h2>Product 1</h2>
                                        </a>
                                        ...
                                        <div class="separador_boton_precio">
                                            <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="boton_ver_mas">
                                                Add
                                                <svg class="icono_ver_mas" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                    ...
                    if (mysqli_num_rows($consulta_prod_indiv) > 0) {
                            ...
                            echo '
                                    <div class="item_individual elementoScroll">
                                        <div class="item_informacion_individual">
                                            <div>
                                                <h2>' . addslashes($datos_prod_indiv["product_name_en"]) . '</h2>';
                            ...
                            echo '
                                        ...
                                        <a href="#" class="item_individual_enlace btn_productos">
                                            <figure class="item_individual_img">
                                                <img src="' . $datos_prod_indiv["product_image"] . '" alt="' . $datos_prod_indiv["product_name_en"] . '">
                                            </figure>
                                        </a>
                                    </div>
                                ';
                        ...
                        echo '
                                <div class="item_individual elementoScroll">
                                    <div class="item_informacion_individual">
                                        <div>
                                            <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="btn_agg_prod efecto_edit" title="Add a product here">
                                                <h2>Product 3</h2>
                                            </a>
                                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore dolore accusamus esse itaque amet, aperiam quis delectus ut ipsum, officiis earum nobis adipisci, illum quas? Rem quis nemo eos hic.</p>
                                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore dolore accusamus esse itaque amet, aperiam quis delectus ut ipsum, officiis earum nobis adipisci, illum quas? Rem quis nemo eos hic.</p>
                                    ...
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="item_individual_enlace efecto_edit" title="Add a product here">
                                        <figure class="item_individual_img">
                                            <img src="../img/banner-default.png" alt="item">
                                        </figure>
                                    </a>
                        ...
                        while ($datos_prod_limit = mysqli_fetch_array($consulta_prod_limit)) {
                            echo '
                                    <div class="item_doble elementoScroll">
                                        <a href="#" class="item_doble_enlace btn_productos">
                                            <figure class="item_doble_img">
                                                <img src="' . $datos_prod_limit["product_image"] . '" alt="' . $datos_prod_limit["product_name_en"] . '">
                                            </figure>
                                        </a>
            ...
            <h2 class="titulo_secundario">
                Products <strong style="color: <?php if (isset($color_p)) {
                    echo $color_p;
                } else {
                    echo 'var(--color-primario)';
                } ?>;">Carousel</strong>
                ...
                <div class="carousel_wrapper">
                    <?php
                        if (mysqli_num_rows($consulta_productos_img) > 0) {
                            ...
                            echo '
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Add a product here">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Producto 1">
                                        </figure>
                                    </a>
                
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Add a product here">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Product 2">
                                        </figure>
                                    </a>
                
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Add a product here">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Producto 3">
                                        </figure>
                                    </a>
                
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Add a product here">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Producto 4">
                                        </figure>
                                    </a>
                
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Add a product here">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Producto 5">
                                        </figure>
                                    </a>
                
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Add a product here">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Producto 6">
                                        </figure>
                                    </a>
                
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Add a product here">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Producto 7">
                                        </figure>
                                    </a>
                                ';
                        } else {
                            echo '
                                    ...
                                    <a href="#" class="carousel_contenedor_imagen btn_productos">
                                        <figure>
                                            <img src="../img/banner-default.png" alt="Producto 2">
                                        </figure>
                                    </a>
            ...
            <h2 class="titulo_secundario fondo_titulo">
                <?php
                    if (isset($datos_plantilla['subtitulo_t']) && !empty($datos_plantilla['subtitulo_t'])) {
                        ...
                        echo '
                                <a href="https://platform.kalstein.net/template-editor/assets/vistas/datosTienda.php#subtitulo_tienda" class="btn_titulo_tienda efecto_edit" title="Add a Subtitle Here">
                                    Secondary Title of Your Store!
                                </a>
                            ';
                    } else {
                        echo 'Secondary Title of Your Store!';
                    }
                ?>
            </h2>
                ...
                <?php
                    if (mysqli_num_rows($consulta_productos_img_dos) > 0) {
                            ...
                            echo '
                                    <div class="contenedor_img_individual">
                                        <figure class="img_individual">
                                            <img src="' . $datos_prod_img["product_image"] . '" alt="Extra Products">
                                        </figure>
                        ...
                        echo '
                                ...
                                <div class="contenedor_img_individual">
                                    <figure class="img_individual">
                                        <img src="../img/banner-default.png" alt="banner two">
                                    </figure>
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="img_individual_enlace" title="Add a product here">
                                        Add
                                        <svg class="icono_ver_mas-white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                                            <path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/>
                                        </svg>
                                ...
                                <div class="contenedor_img_individual">
                                    <figure class="img_individual">
                                        <img src="../img/banner-default.png" alt="banner three">
                                    </figure>
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="img_individual_enlace" title="Add a product here">
                                        Add
                                        <svg class="icono_ver_mas-white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
            ...
            <div class="contenedor_info">
                <h2 class="titulo_secundario">
                    Company <strong style="color: <?php if (isset($color_p)) {
                        echo $color_p;
                    } else {
                        echo 'var(--color-primario)';
                    } ?>;">Information</strong>
                ...
                <div class="historia elementoScroll">
                    <?php
                        if (isset($datos_plantilla['quienes_somos_t']) && !empty($datos_plantilla['quienes_somos_t'])) {
                            ...
                            echo '
                                    <a href="https://platform.kalstein.net/template-editor/assets/vistas/datosTienda.php#quienes_somos" class="btn_contenedor_tienda_dos" title="Add Your Business Identity Here">
                                        <div class="historia_datos_dos">
                                            <h2>Who are we?</h2>
                                            <p>
                    ...
                    <figure class="historia_img">
                        <?php
                            if (!empty($datos_plantilla['img_quienes_s'])) {
                                ...
                                echo '
                                        <a href="https://platform.kalstein.net/template-editor/assets/vistas/imagenes.php#quienes_somos_t" class="efecto_edit" title="Add an image here">
                                            <img src="../img/banner-default.png" alt="imagen_empresa">
                                        </a>
                                    ';
                            } else {
                                echo '<img src="../img/banner-default.png" alt="imagen_empresa">';
                            }
                        ?>
                    </figure>
                </div>
                        ...
                        if (isset($datos_plantilla['mision']) && !empty($datos_plantilla['mision'])) {
                            echo '
                                    <div class="mision_datos">
                                        <h2>Our Business Mission</h2>
                                        <p>' . $datos_plantilla['mision'] . '</p>
                                    </div>
                                ';
                        } elseif ($tipo_usuario['account_rol_aid'] == 2 || $tipo_usuario['account_rol_aid'] == 3 || $tipo_usuario['account_rol_aid'] == 4) {
                            echo '
                                    <a href="https://platform.kalstein.net/template-editor/assets/vistas/datosTienda.php#mision_tienda" class="btn_contenedor_tienda_dos" title="Add Your Business Mission Here">
                                        <div class="mision_datos_dos">
                                            <h2>Our Business Mission</h2>
                                            <p>
                                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus reiciendis aspernatur eaque fuga, obcaecati laboriosam laudantium. Accusamus illum, sed asperiores eum libero cupiditate perferendis, dolorum, natus quis laborum culpa nam.
                                            </p>
                    ...
                    <figure class="mision_img">
                        <?php
                            if (!empty($datos_plantilla['img_mision'])) {
                                ...
                                echo '
                                        <a href="https://platform.kalstein.net/template-editor/assets/vistas/imagenes.php#mision_img" class="efecto_edit" title="Add an image here">
                                            <img src="../img/banner-default.png" alt="imagen_empresa">
                                        </a>
                                    ';
                            } else {
                ...
                <div class="vision elementoScroll">
                    <?php
                        if (isset($datos_plantilla['vision']) && !empty($datos_plantilla['vision'])) {
                            ...
                            echo '
                                    <a href="https://platform.kalstein.net/template-editor/assets/vistas/datosTienda.php#vision_tienda" class="btn_contenedor_tienda_dos" title="Add Your Business Vision Here">
                                        <div class="vision_datos_dos">
                                            <h2>Our Business Vision</h2>
                                            <p>
                                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus reiciendis aspernatur eaque fuga, obcaecati laboriosam laudantium. Accusamus illum, sed asperiores eum libero cupiditate perferendis, dolorum, natus quis laborum culpa nam.
                                            </p>
                    ...
                    <figure class="vision_img">
                        <?php
                            if (!empty($datos_plantilla['img_vision'])) {
                                ...
                                echo '
                                        <a href="https://platform.kalstein.net/template-editor/assets/vistas/imagenes.php#imagen_vision" class="efecto_edit" title="Add an image here">
                                            <img src="../img/banner-default.png" alt="imagen_empresa">
                                        </a>
                                    ';
                            } else {
                ...
                if ($showButton) {
                    echo '
                            <a href="../../dashboard.php" class="btn_dashboard">
                                <span>Go back to the editor</span>
                            </a>
    ...
    <div id="seccion_productos">
        ...
        <div class="contenedor_patron_css">
            <main class="contenedor_principal">
                <h1 class="titulo_extra">PRODUCTS</h1>
                ...
                <div class="grid-container">
                    ...
                    if (mysqli_num_rows($consulta_render_products) > 0) {
                        while ($datos_producto = mysqli_fetch_array($consulta_render_products)) {
                            $parrafos_descripcion_dos = explode("\n", $datos_producto["product_description"]);
                            $titulo_original = $datos_producto["product_name_en"];
                                ...
                                <div class="grid-item">
                                    <div class="contenedor_producto" id="producto' . $datos_producto["product_aid"] . '">
                                        <figure class="producto_img">
                                            <img src="' . $datos_producto["product_image"] . '" alt="' . $datos_producto["product_name_en"] . '">
                                        </figure>
                            ...
                            if (!empty($datos_producto["resultado_renderP"])) {
                                ...
                                echo '
                                    <a href="https://platform.kalstein.net/template-editor/assets/vistas/products3d.php" class="btn_render_product btn_to_render">
                                        Render this product in 3D
                                    </a>
                                ';
                            }
                            ...
                            if (!empty($datos_producto["product_technical_description"])) {
                                echo '
                                    <h4>Features:</h4>
                                    <table class="p-prev-table">' . $datos_producto["product_technical_description"] . '</table>
                                ';
                            }

                            echo '
                                                <div class="contenedor_boton_ver_mas">
                                                    <a href="https://platform.kalstein.net/account_redirect/?search=' . $datos_producto["product_model"] . '" class="boton_ver_mas btn_cotizar">
                                                        <span>Quote</span>
                                                        <svg class="icono_ver_mas" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                        ...
                        if ($tipo_usuario['account_rol_aid'] == 2 || $tipo_usuario['account_rol_aid'] == 3 || $tipo_usuario['account_rol_aid'] == 4) {
                            echo '
                                    <span class="subirtext">You havent uploaded any Products</span>
                                    <a href="https://platform.kalstein.net/distribuidor/productos/agregar/" class="btn_agregar_producto" title="Add a product here">
                                        Add a product!
                                    </a>
                                ';
                        } else {
    ...
    <?php
        include ("../includes/footer_plantilla.php");
    ?>

    <!-- Scripts -->
    <script src="../js/jquery-3.6.0.min.js"></script>
    <script src="../js/plantilla/main.js"></script>
    <script src="../js/plantilla/productos.js"></script>
    <script src="../js/plantilla/footer_plantilla.js"></script>
</body>
