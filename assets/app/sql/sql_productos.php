<?php
// omitir este archivo de momento
/* ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL); */
require '/home/he270716/public_html/plataforma/wp-content/plugins/kalsteinPerfiles/php/conexion.php';
...
//verificar cookie query 
if (isset($_COOKIE['query'])) {
  $textoBusqueda = $_COOKIE['query'];
} else {
  $textoBusqueda = '';
}
...
if ($textoBusqueda != '') {
  $sql_render_products = "SELECT * FROM wp_k_products 
