<div class="barra_lateral">
    <div class="barra_lateral_items">
        ...
        <a href="datosTienda.php" class="item">
            <i class="fa-solid fa-database"></i>
            Store Details
        </a>
        <a href="datosTienda.php" class="item_small">
            <i class="fa-solid fa-database"></i>
        </a>

        <a href="estilos.php" class="item">
            <i class="fa-solid fa-palette"></i>
            Styles
        </a>
        <a href="estilos.php" class="item_small">
            <i class="fa-solid fa-palette"></i>
        </a>

        <a href="imagenes.php" class="item">
            <i class="fa-solid fa-images"></i>
            Images
        </a>
        <a href="imagenes.php" class="item_small">
            <i class="fa-solid fa-images"></i>
        </a>

        <a href="products3d.php" class="item">
            <i class="fa-solid fa-cube"></i>
            Render 3D
        </a>
        <a href="products3d.php" class="item_small">
            <i class="fa-solid fa-cube"></i>
        </a>
    </div>
